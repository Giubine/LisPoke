package com.example.listpoke.util
...
fun changeTypeColor(typeField : String, wrappedDrawable : Drawable){
    when(typeField){
        ...
        "bug" -> DrawableCompat.setTint(wrappedDrawable, Color.parseColor("#2CDAB1"))
        "poison" -> DrawableCompat.setTint(wrappedDrawable, Color.parseColor("#FF6200EE"))
        "electric" -> DrawableCompat.setTint(wrappedDrawable, Color.parseColor("#FFCE4B"))
